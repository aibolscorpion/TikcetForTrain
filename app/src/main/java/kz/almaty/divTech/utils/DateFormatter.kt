...
object DateFormatter {
    ...
    fun formatDate(date : String): String {
        val dateTimeFormatter1 = DateTimeFormatter.ofPattern("d.M.yyyy")
        val dateTimeFormatter2 = DateTimeFormatter.ofPattern("d MMMM y")
    ...
    fun formatDateForRequest(date : String): String {
        val dateTimeFormatter1 = DateTimeFormatter.ofPattern("d.M.yyyy")
        val dateTimeFormatter2 = DateTimeFormatter.ofPattern("yyyy-MM-dd")
        val formattedCheckInDate = LocalDate.parse(date, dateTimeFormatter1)
    ...
    fun formatDateAndTime(unformattedDateTime : String?): ArrayList<String> {
        ...
        val dateTimeFormatter1 = DateTimeFormatter.ofPattern("yyyy-M-d HH:mm:ss")
